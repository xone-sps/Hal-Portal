    ...
    <div class="flex justify-between">
      ...
      <div class="w-1/3">
        <div ref="billRef" class="p-4 max-w-md mx-auto bg-white">
          ...
          <div class="flex justify-between items-center pb-3">
            ...
            <div class="text-right">
              ...
              <p class="font-semibold text-gray-800">
                {{ inboundStore.shipmentInfo.pickup_date }}
              </p>
            </div>
          </div>
          ...
          <div class="my-4">
            <div class="flex justify-between items-center">
              ...
              <span class="font-semibold">
                {{ inboundStore.shipmentInfo.bill_number }}
              </span>
              <CopyOutlined
            ...
            >
              <span>
                {{ inboundStore.shipmentInfo.from_branch_code
                }}{{ inboundStore.shipmentInfo.from_branch_prefix }}-{{
                  inboundStore.shipmentInfo.from_branch
                }}
              </span>
              ...
              <span>
                {{ inboundStore.shipmentInfo.destination_branch_code
                  ...
                  inboundStore.shipmentInfo.destination_branch
                }}
              </span>
            </div>
          </div>
          ...
          >
            {{ inboundStore.shipmentInfo.parcel_category_name }}
          </h4>
            ...
            <div class="flex justify-between">
              <div>
                ...
                <p class="font-semibold">
                  {{ inboundStore.shipmentInfo.sender_name }}
                </p>
              ...
              <div class="text-right">
                ...
                <p class="font-semibold">
                  {{ inboundStore.shipmentInfo.receiver_name }}
                </p>
                <p class="text-gray-500 text-sm">
                  {{ inboundStore.shipmentInfo.receiver_phone_number }}
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="font-semibold">
                  ...
                  {{ inboundStore.shipmentInfo.weight_unit }}
                </span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-500">ຈຳນວນ</span>
                <span class="font-semibold">
                  {{ inboundStore.shipmentInfo.item_count }}
                </span>
              </div>
              <div class="flex justify-between">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-semibold">
                  {{
                    inboundStore.shipmentInfo.total_price != null
                      ? inboundStore.shipmentInfo.total_price.toLocaleString()
                      : "-"
                  }}
                  LAK</span
                >
              ...
              <div class="flex justify-between">
                ...
                <span class="font-semibold">
                  {{
                    inboundStore.shipmentInfo.total_freight != null
                      ? inboundStore.shipmentInfo.total_freight.toLocaleString()
                      : "-"
                  }}
                  LAK</span
                >
              ...
              <div class="flex justify-between">
                ...
                <span class="font-semibold text-red-500">
                  {{
                    (
                      (inboundStore.shipmentInfo.total_freight != null
                        ? inboundStore.shipmentInfo.total_freight
                        : 0) +
                      (inboundStore.shipmentInfo.total_price != null
                        ? inboundStore.shipmentInfo.total_price
                        : 0)
                    ).toLocaleString() || "-"
                  }}
                  LAK
            ...
            >
              ...
              <div>
                <div class="font-semibold text-gray-800">
                  {{ item.place }}
                  <span v-if="index === latestIndex" class="ml-1 text-green-500"
                    >●</span
                  >
                </div>
