...
const handleSearch = () => {
  if(startDate.value != null && endDate.value != null){
    outboundStore.fetchOutboundData({status: 'success',query:searchQuery.value,startDate:startDate.value.format('YYYY-MM-DD'),endDate:endDate.value.format('YYYY-MM-DD')},);
  }
};
