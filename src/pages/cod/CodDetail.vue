      ...
      <div class="flex justify-between items-center">
        <div>
          <p class="text-lg font-bold">
            {{ codStore.codDetail.invoice_number }}​​​    
          </p>
        </div>
        <!-- <a-button
          type="default"
          class="!bg-orange-500 !text-white rounded-md px-4 py-2"
        >
          ລໍຖ້າການໂອນ
        </a-button> -->
      </div>
            ...
            {{
              codStore.codDetail.total_price
                ? new Intl.NumberFormat("en-US", {
                  ...
                  }).format(codStore.codDetail.total_price)
                : "-"
            }}
            LAK
          </p>
            ...
            {{
              codStore.codDetail.sub_total_price
                ? new Intl.NumberFormat("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }).format(codStore.codDetail.sub_total_price)
                : "-"
            }}
            LAK
          </p>
            ...
            {{
              codStore.codDetail.cod_fee_percent
                ? new Intl.NumberFormat("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }).format(codStore.codDetail.cod_fee_percent)
                : "-"
            }}
            %
          </p>
            ...
            {{
              codStore.codDetail.transfer_fee
                ? new Intl.NumberFormat("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }).format(codStore.codDetail.transfer_fee)
                : "-"
            }}
            LAK
          </p>
...
const columns = [
  {
    title: "ເລກພັດສະດຸ",
    dataIndex: ["shipment_payment", "shipment", "shipment_number"],
    key: "shipment",
  },
  {
    title: "ປະເພດພັດສະດຸ",
  ...
  {
    title: "ລາຄາຄ່າສົ່ງ",
    dataIndex: ["shipment_payment", "paid"],
    key: "shipment",
  ...
  {
    title: "ສາຂາປາຍທາງ",
    dataIndex: ["shipment_payment", "shipment", "end_branch", "name"],
    key: "end_branch",
  },
  {
    title: "ວັນທີສົ່ງບິນ",
