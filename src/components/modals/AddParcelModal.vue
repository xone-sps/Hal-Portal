  ...
  >
    <template #title>
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <a-avatar size="small" class="!bg-orange-600 text-white font-bold"
            >S</a-avatar
          >
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 mt-4">
          ...
          <a-form-item label="ເບີໂທ" name="receiverPhone">
            <a-input-group compact>
              <!-- Prefix Select -->
              <a-form-item-rest>
                <a-select v-model:value="prefixPhone" style="width: 70px">
        ...
        <div class="!mt-4">
          ...
          <a-form-item label="ນໍ້າໜັກ (kg)" name="weight">
            <a-input-number
              ...
              @keydown.enter="calculateFreight"
              @change="calculateFreight"
            />
          </a-form-item>
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        <a-button @click="handleCancel" type="primary" class="w-full"
          >ຍົກເລີກ</a-button
        >
        <a-button
          @click="resetForm"
          type="primary"
          class="!bg-red-500 w-full text-white"
          >ເຄຍຂໍ້ມູນ</a-button
        >
        <a-button
          type="primary"
