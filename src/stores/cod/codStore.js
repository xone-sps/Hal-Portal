...
export const useCodStore = defineStore("codStore", {
    state: () => ({
        ...
        startDate: dayjs().subtract(3, "month"), // ✅ Initialize as Dayjs object
        endDate: dayjs(), // ✅ Initialize as Dayjs object
    }),
    actions: {
        ...
        async downloadPdf(data) {
            ...
            try {
                ...
                const response = await api.post("download-cod-receipt-template/" + data.id, {
