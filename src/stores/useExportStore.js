...
export const useExportStore = defineStore('export', {
    ...
    actions: {
        ...
        async onUploadValidateData(body) {
            ...
            try {
                eventSource = new AuthenticationEventSource(`${apiUrl}/v1/auth/users/me/shipments/management/imports/pre-shipment/progress/${body.import_id}`, store.getters['auth/token']);
